...
class PascalVOCSegmentation(data.Dataset):
    ...
    def __init__(self,
        ...
        # GILAD
        self.point_annotations = get_pascal_object_part_points(os.path.join(
        ...
        # network_dims.update(label_attrs)  # GILAD
    ...
    def __getitem__(self, index):
        ...
        _point_target = get_point_mask(
            point_annotations,
            self.mask_type,
            np.array(_semantic_target).shape, self.point_mask_anno_params)
